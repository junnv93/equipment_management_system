...
export enum Permission {
  ...
  /** 대여(rental) 1차 승인 — 사용 부서 기술책임자 전용 */
  BORROWER_APPROVE_CHECKOUT = 'borrower_approve:checkout',
  /** 대여(rental) 1차 반려 — 사용 부서 기술책임자 전용 */
...
export const PERMISSION_LABELS: Record<Permission, string> = {
  ...
  [Permission.BORROWER_APPROVE_CHECKOUT]: '대여 1차 승인 (사용 부서)',
  [Permission.BORROWER_REJECT_CHECKOUT]: '대여 1차 반려 (사용 부서)',
