...
export default function InboundCheckoutsTab({
  ...
  const renderRentalImportsList = () => {
    ...
    return (
      <div className="space-y-3">
        <h3 className="text-sm font-medium text-muted-foreground">{t('inbound.externalRental')}</h3>
        <Card>
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>{t('inbound.vendor')}</TableHead>
  ...
  return (
    <div className="space-y-6">
      ...
      {hasInboundCheckouts && (
        <div className="space-y-3">
          <h3 className="text-sm font-medium text-muted-foreground">{t('inbound.teamLoan')}</h3>
