                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>알림을 받는 빈도를 설정합니다.</FormDescription>
                        </FormItem>
                      )}
                    />
                        ...
                        render={({ field }) => (
                          <FormItem className="flex items-center justify-between space-x-2">
                            <div>
                              ...
                              <FormDescription>장비 교정 일정 알림</FormDescription>
                            </div>
                            <FormControl>
                              <Switch checked={field.value} onCheckedChange={field.onChange} />
                            </FormControl>
                        ...
                        render={({ field }) => (
                          <FormItem className="flex items-center justify-between space-x-2">
                            <div>
                              ...
                              <FormDescription>장비 교정 완료 알림</FormDescription>
                            </div>
                            <FormControl>
                              <Switch checked={field.value} onCheckedChange={field.onChange} />
                            </FormControl>
                        ...
                        render={({ field }) => (
                          <FormItem className="flex items-center justify-between space-x-2">
                            <div>
                              ...
                              <FormDescription>장비 유지보수 관련 알림</FormDescription>
                            </div>
                            <FormControl>
                              <Switch checked={field.value} onCheckedChange={field.onChange} />
                            </FormControl>
                        ...
                        render={({ field }) => (
                          <FormItem className="flex items-center justify-between space-x-2">
                            <div>
                              ...
                              <FormDescription>장비 대여 요청 알림</FormDescription>
                            </div>
                            <FormControl>
                              <Switch checked={field.value} onCheckedChange={field.onChange} />
                            </FormControl>
                        ...
                        render={({ field }) => (
                          <FormItem className="flex items-center justify-between space-x-2">
                            <div>
                              ...
                              <FormDescription>장비 대여 승인 알림</FormDescription>
                            </div>
                            <FormControl>
                              <Switch checked={field.value} onCheckedChange={field.onChange} />
                            </FormControl>
                        ...
                        render={({ field }) => (
                          <FormItem className="flex items-center justify-between space-x-2">
                            <div>
                              ...
                              <FormDescription>장비 대여 거절 알림</FormDescription>
                            </div>
                            <FormControl>
                              <Switch checked={field.value} onCheckedChange={field.onChange} />
                            </FormControl>
                        ...
                        render={({ field }) => (
                          <FormItem className="flex items-center justify-between space-x-2">
                            <div>
                              ...
                              <FormDescription>장비 반납 요청 알림</FormDescription>
                            </div>
                            <FormControl>
                              <Switch checked={field.value} onCheckedChange={field.onChange} />
                            </FormControl>
                        ...
                        render={({ field }) => (
                          <FormItem className="flex items-center justify-between space-x-2">
                            <div>
                              ...
                              <FormDescription>장비 반납 승인 알림</FormDescription>
                            </div>
                            <FormControl>
                              <Switch checked={field.value} onCheckedChange={field.onChange} />
                            </FormControl>
                        ...
                        render={({ field }) => (
                          <FormItem className="flex items-center justify-between space-x-2">
                            <div>
                              ...
                              <FormDescription>장비 반납 거절 알림</FormDescription>
                            </div>
                            <FormControl>
                              <Switch checked={field.value} onCheckedChange={field.onChange} />
                            </FormControl>
                        ...
                        render={({ field }) => (
                          <FormItem className="flex items-center justify-between space-x-2">
                            <div>
                              ...
                              <FormDescription>장비 체크아웃 관련 알림</FormDescription>
                            </div>
                            <FormControl>
                              <Switch checked={field.value} onCheckedChange={field.onChange} />
                            </FormControl>
                      ...
                      render={({ field }) => (
                        <FormItem className="flex items-center justify-between space-x-2">
                          <div>
                            ...
                            <FormDescription>시스템 점검 및 중요 공지 알림</FormDescription>
                          </div>
                          <FormControl>
                            <Switch checked={field.value} onCheckedChange={field.onChange} />
                          </FormControl>
