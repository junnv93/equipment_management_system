...
import { Search, Plus, Filter, Calendar, CheckSquare, ClipboardList, AlertTriangle, Clock } from "lucide-react";
import maintenanceApi, { Maintenance, MaintenanceSummary } from "@/lib/api/maintenance-api";
          ...
          <TableBody>
            {maintenancesLoading ? (
              ...
              maintenancesData?.data?.map((maintenance: Maintenance) => (
                <TableRow key={maintenance.id} className="cursor-pointer hover:bg-muted/50" onClick={() => router.push(`/maintenance/${maintenance.id}`)}>
                  ...
                  <TableCell>
                    {getMaintenanceTypeText(maintenance.maintenanceType)}
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    {getMaintenanceResultBadge(maintenance.result)}
                  </TableCell>
                </TableRow>
              ))
            )}
