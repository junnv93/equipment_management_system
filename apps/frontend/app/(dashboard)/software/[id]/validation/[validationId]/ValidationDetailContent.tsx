...
export default function ValidationDetailContent({
  ...
  // P0-1: 승인 워크플로 stepper 시각화 — adapter hook이 SoftwareValidation → step descriptor 변환
  const stepperSteps = useSoftwareValidationProgressSteps({
    status: validation.status,
    submittedAt: validation.submittedAt,
    technicalApprovedAt: validation.technicalApprovedAt,
    qualityApprovedAt: validation.qualityApprovedAt,
  });
