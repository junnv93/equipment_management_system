/**
 * Seed File for Group A: API Manual Trigger Tests
...
test.describe('Group A: Manual Trigger - Seed Setup', () => {
  ...
  test('Verify test-login endpoint works for all required roles', async ({ request }) => {
