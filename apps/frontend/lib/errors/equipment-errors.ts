...
export function mapBackendErrorCode(backendCode?: string): EquipmentErrorCode {
  ...
  const mappings: Record<string, EquipmentErrorCode> = {
    // 중복 에러
    [ErrorCode.DuplicateManagementNumber]: EquipmentErrorCode.DUPLICATE_MANAGEMENT_NUMBER,
    [ErrorCode.EquipmentManagementNumberDuplicate]: EquipmentErrorCode.DUPLICATE_MANAGEMENT_NUMBER,
    [ErrorCode.DuplicateSerialNumber]: EquipmentErrorCode.DUPLICATE_SERIAL_NUMBER,
    DUPLICATE_ERROR: EquipmentErrorCode.DUPLICATE_ERROR,
    [ErrorCode.Conflict]: EquipmentErrorCode.DUPLICATE_ERROR,
    [ErrorCode.VersionConflict]: EquipmentErrorCode.VERSION_CONFLICT,
    [ErrorCode.EquipmentRequestAlreadyProcessed]: EquipmentErrorCode.DUPLICATE_ERROR,

    // 검증 에러
    [ErrorCode.ValidationError]: EquipmentErrorCode.VALIDATION_ERROR,
    [ErrorCode.BadRequest]: EquipmentErrorCode.VALIDATION_ERROR,
    INVALID_INPUT: EquipmentErrorCode.VALIDATION_ERROR,
    [ErrorCode.EquipmentInvalidCalibrationDue]: EquipmentErrorCode.VALIDATION_ERROR,
    [ErrorCode.EquipmentInvalidCalibrationDueAfter]: EquipmentErrorCode.VALIDATION_ERROR,
    [ErrorCode.EquipmentSiteRequired]: EquipmentErrorCode.VALIDATION_ERROR,
    [ErrorCode.EquipmentCalibrationOverdueStatusBlock]: EquipmentErrorCode.VALIDATION_ERROR,
    [ErrorCode.EquipmentManagementNumberRequired]:
      EquipmentErrorCode.EQUIPMENT_MANAGEMENT_NUMBER_REQUIRED,
    [ErrorCode.EquipmentFileRequired]: EquipmentErrorCode.EQUIPMENT_FILE_REQUIRED,
    [ErrorCode.EquipmentAttachmentTypeRequired]:
      EquipmentErrorCode.EQUIPMENT_ATTACHMENT_TYPE_REQUIRED,
    [ErrorCode.EquipmentFormDataParseFailed]: EquipmentErrorCode.FORM_DATA_PARSE_FAILED,
    [ErrorCode.EquipmentInvalidManagementNumber]: EquipmentErrorCode.INVALID_MANAGEMENT_NUMBER,
    [ErrorCode.EquipmentRequestNoEquipmentId]: EquipmentErrorCode.VALIDATION_ERROR,
    [ErrorCode.EquipmentRequestRejectionReasonRequired]: EquipmentErrorCode.VALIDATION_ERROR,
    [ErrorCode.NcInvalidIncidentType]: EquipmentErrorCode.VALIDATION_ERROR,

    // 권한 에러
    [ErrorCode.Unauthorized]: EquipmentErrorCode.UNAUTHORIZED,
    [ErrorCode.Forbidden]: EquipmentErrorCode.PERMISSION_DENIED,
    [ErrorCode.PermissionDenied]: EquipmentErrorCode.PERMISSION_DENIED,
    ACCESS_DENIED: EquipmentErrorCode.PERMISSION_DENIED,
    [ErrorCode.ScopeAccessDenied]: EquipmentErrorCode.SCOPE_ACCESS_DENIED,
    [ErrorCode.EquipmentSiteScopeOnly]: EquipmentErrorCode.EQUIPMENT_SITE_SCOPE_ONLY,
    [ErrorCode.EquipmentTeamScopeOnly]: EquipmentErrorCode.EQUIPMENT_TEAM_SCOPE_ONLY,
    [ErrorCode.EquipmentSharedCannotUpdate]: EquipmentErrorCode.EQUIPMENT_SHARED_CANNOT_UPDATE,
    [ErrorCode.EquipmentSharedCannotDelete]: EquipmentErrorCode.EQUIPMENT_SHARED_CANNOT_DELETE,
    [ErrorCode.EquipmentManagerRoleInsufficient]: EquipmentErrorCode.PERMISSION_DENIED,
    [ErrorCode.EquipmentManagerSiteMismatch]: EquipmentErrorCode.PERMISSION_DENIED,
    [ErrorCode.EquipmentRequestNoViewPermission]: EquipmentErrorCode.PERMISSION_DENIED,
    [ErrorCode.EquipmentRequestNoApprovePermission]: EquipmentErrorCode.PERMISSION_DENIED,
    [ErrorCode.EquipmentRequestSelfApprovalForbidden]: EquipmentErrorCode.PERMISSION_DENIED,
    [ErrorCode.EquipmentRequestTeamScopeViolation]: EquipmentErrorCode.SCOPE_ACCESS_DENIED,
    [ErrorCode.EquipmentRequestNoRejectPermission]: EquipmentErrorCode.PERMISSION_DENIED,
    [ErrorCode.EquipmentRequestSelfRejectionForbidden]: EquipmentErrorCode.PERMISSION_DENIED,

    // 리소스 에러
    [ErrorCode.NotFound]: EquipmentErrorCode.NOT_FOUND,
    [ErrorCode.EntityNotFound]: EquipmentErrorCode.NOT_FOUND,
    [ErrorCode.EquipmentNotFound]: EquipmentErrorCode.EQUIPMENT_NOT_FOUND,
    [ErrorCode.CableNotFound]: EquipmentErrorCode.NOT_FOUND,
    [ErrorCode.NonConformanceNotFound]: EquipmentErrorCode.NOT_FOUND,
    [ErrorCode.SoftwareValidationNotFound]: EquipmentErrorCode.NOT_FOUND,
    [ErrorCode.TestSoftwareNotFound]: EquipmentErrorCode.NOT_FOUND,
    ...
    [ErrorCode.EquipmentRequestNotFound]: EquipmentErrorCode.NOT_FOUND,
    [ErrorCode.EquipmentManagerNotFound]: EquipmentErrorCode.NOT_FOUND,

    // 보정계수 에러
    [ErrorCode.CalibrationFactorNotFound]: EquipmentErrorCode.NOT_FOUND,
    [ErrorCode.CalibrationFactorOnlyPendingCanApprove]: EquipmentErrorCode.VALIDATION_ERROR,
    [ErrorCode.CalibrationFactorOnlyPendingCanReject]: EquipmentErrorCode.VALIDATION_ERROR,
    [ErrorCode.CalibrationFactorRejectionReasonRequired]: EquipmentErrorCode.VALIDATION_ERROR,

    // 문서 에러
    [ErrorCode.DocumentFileRequired]: EquipmentErrorCode.VALIDATION_ERROR,
    [ErrorCode.DocumentOwnerRequired]: EquipmentErrorCode.VALIDATION_ERROR,
    [ErrorCode.DocumentTypeCountMismatch]: EquipmentErrorCode.VALIDATION_ERROR,
    [ErrorCode.CalibrationFileRequired]: EquipmentErrorCode.VALIDATION_ERROR,

    // 파일 에러
    [ErrorCode.FileTooLarge]: EquipmentErrorCode.FILE_TOO_LARGE,
    PAYLOAD_TOO_LARGE: EquipmentErrorCode.FILE_TOO_LARGE,
    [ErrorCode.InvalidFileType]: EquipmentErrorCode.INVALID_FILE_TYPE,
    UNSUPPORTED_MEDIA_TYPE: EquipmentErrorCode.INVALID_FILE_TYPE,
    [ErrorCode.FileEmpty]: EquipmentErrorCode.FILE_EMPTY,
    [ErrorCode.FileContentMismatch]: EquipmentErrorCode.FILE_CONTENT_MISMATCH,
    [ErrorCode.FileSaveFailed]: EquipmentErrorCode.FILE_UPLOAD_FAILED,
    [ErrorCode.FileReadFailed]: EquipmentErrorCode.FILE_UPLOAD_FAILED,
    [ErrorCode.FileUploadFailed]: EquipmentErrorCode.FILE_UPLOAD_FAILED,

    // 서버 에러
    [ErrorCode.InternalServerError]: EquipmentErrorCode.SERVER_ERROR,
    SERVER_ERROR: EquipmentErrorCode.SERVER_ERROR,
    [ErrorCode.EquipmentRequestCreateFailed]: EquipmentErrorCode.SERVER_ERROR,
    [ErrorCode.EquipmentRequestUpdateFailed]: EquipmentErrorCode.SERVER_ERROR,
    [ErrorCode.EquipmentRequestDeleteFailed]: EquipmentErrorCode.SERVER_ERROR,
    [ErrorCode.EquipmentRequestListFailed]: EquipmentErrorCode.SERVER_ERROR,
    [ErrorCode.EquipmentRequestFetchFailed]: EquipmentErrorCode.SERVER_ERROR,
    [ErrorCode.EquipmentRequestApproveFailed]: EquipmentErrorCode.SERVER_ERROR,
    [ErrorCode.EquipmentRequestRejectFailed]: EquipmentErrorCode.SERVER_ERROR,

    // 부적합 에러
    [ErrorCode.NcRepairRecordRequired]: EquipmentErrorCode.NC_REPAIR_RECORD_REQUIRED,
    [ErrorCode.NcRecalibrationRequired]: EquipmentErrorCode.NC_RECALIBRATION_REQUIRED,

    // 데이터 마이그레이션 에러
    MIGRATION_FILE_REQUIRED: EquipmentErrorCode.VALIDATION_ERROR,
    MIGRATION_EMPTY_FILE: EquipmentErrorCode.VALIDATION_ERROR,
    MIGRATION_NO_DATA_ROWS: EquipmentErrorCode.VALIDATION_ERROR,
    MIGRATION_NO_HEADERS: EquipmentErrorCode.VALIDATION_ERROR,
    MIGRATION_SESSION_NOT_FOUND: EquipmentErrorCode.NOT_FOUND,
    MIGRATION_SESSION_OWNERSHIP_DENIED: EquipmentErrorCode.PERMISSION_DENIED,
    MIGRATION_SITE_ACCESS_DENIED: EquipmentErrorCode.PERMISSION_DENIED,

    // 장비 반입 에러
    [ErrorCode.EquipmentImportOnlyPendingCanApprove]: EquipmentErrorCode.VALIDATION_ERROR,
    [ErrorCode.EquipmentImportOnlyPendingCanReject]: EquipmentErrorCode.VALIDATION_ERROR,
    [ErrorCode.EquipmentImportOnlyApprovedCanReceive]: EquipmentErrorCode.VALIDATION_ERROR,
    [ErrorCode.EquipmentImportOnlyReceivedCanReturn]: EquipmentErrorCode.VALIDATION_ERROR,
    [ErrorCode.EquipmentImportOnlyPendingOrApprovedCanCancel]: EquipmentErrorCode.VALIDATION_ERROR,
    [ErrorCode.EquipmentImportOnlyRequesterCanCancel]: EquipmentErrorCode.PERMISSION_DENIED,
    [ErrorCode.EquipmentImportNoLinkedEquipment]: EquipmentErrorCode.VALIDATION_ERROR,
    [ErrorCode.EquipmentImportEndDateBeforeStart]: EquipmentErrorCode.VALIDATION_ERROR,
    IMPORT_TEMP_NUMBER_GENERATION_FAILED: EquipmentErrorCode.SERVER_ERROR,
    [ErrorCode.EquipmentImportVersionRequired]: EquipmentErrorCode.VALIDATION_ERROR,

    // 교정계획서 확인 에러
    [ErrorCode.CalibrationPlanOnlyApprovedCanConfirm]: EquipmentErrorCode.VALIDATION_ERROR,
    [ErrorCode.CalibrationPlanItemNotExecuted]: EquipmentErrorCode.VALIDATION_ERROR,

    // 양식 템플릿 에러
    [ErrorCode.FormTemplateNotFound]: EquipmentErrorCode.FORM_TEMPLATE_NOT_FOUND,
    [ErrorCode.FormNumberAlreadyExists]: EquipmentErrorCode.DUPLICATE_ERROR,
    [ErrorCode.FormHistoryDownloadForbidden]: EquipmentErrorCode.PERMISSION_DENIED,
    [ErrorCode.InvalidFormName]: EquipmentErrorCode.VALIDATION_ERROR,
    [ErrorCode.InvalidFormNumberFormat]: EquipmentErrorCode.VALIDATION_ERROR,
  };
