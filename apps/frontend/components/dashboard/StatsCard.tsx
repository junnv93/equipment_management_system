...
export function StatsCard({
  ...
  return (
    <Card 
      className={`${getVariantClasses()} border transition-all duration-300 hover:shadow-md dark:hover:shadow-lg dark:shadow-gray-900/10 hover:translate-y-[-2px]`}
      hoverable
    >
      <CardContent className="p-6">
        <div className="flex items-center justify-between space-x-4">
          ...
          {Icon && (
            <div className={`p-3 rounded-full ${getIconClasses()} transition-all duration-300`}>
