  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        // Notification animations — easing: globals.css --ease-* SSOT
        'badge-pulse': 'badge-pulse 2s var(--ease-sharp) 3',
        'checkmark-pop': 'checkmark-pop 0.5s var(--ease-spring-pop) forwards',
        'gentle-bounce': 'gentle-bounce 2s ease-in-out infinite',
        // Auth animations
        shake: 'shake 0.5s ease-in-out',
        'fade-in-up': 'fade-in-up 0.6s ease-out forwards',
        'scale-in-subtle': 'scale-in-subtle 0.4s var(--ease-spring-smooth) forwards',
        ...
        'approval-ring-pop': 'approval-ring-pop 0.5s var(--ease-spring-pop) 0.2s both',
        ...
        'stagger-fade-in': 'staggerFadeIn 0.25s var(--ease-spring-smooth) both',
      },
    },
  },
  plugins: [
