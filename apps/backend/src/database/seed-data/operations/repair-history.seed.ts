...
export const REPAIR_HISTORY_SEED_DATA: (typeof repairHistory.$inferInsert)[] = [
  // Linked to NC-006 (Harness Coupler)
  {
    ...
    repairDescription: '내부 연결부 교체 및 재교정 (케이사이트 서비스센터)',
  ...
  // Linked to NC-007 (Current Probe)
  {
    ...
    repairDescription: 'BNC 커넥터 교체 (사내 기술팀)',
    repairResult: 'completed',
  ...
  // Linked to NC-009 (RF Receiver)
  {
    ...
    repairDescription: 'RF 앰프 모듈 전체 교체 (정밀전자 대리점)',
    repairResult: 'completed',
  ...
  // Linked to NC-004 (BCI)
  {
    ...
    repairDescription: '클램프 접촉면 정제 및 재조립 (사내 기술팀)',
    repairResult: 'completed',
  ...
  // Oscilloscope maintenance repair
  {
    ...
    repairDescription: '프로브 보정 및 터치 스크린 교체 (테크트로닉스 인증 서비스)',
    repairResult: 'completed',
  ...
  // Power Supply preventive maintenance
  {
    ...
    repairDescription: '냉각 팬 교체 및 내부 청소 (사내 기술팀)',
    repairResult: 'completed',
  ...
  // Network Analyzer partial repair
  {
    ...
    repairDescription: '디스플레이 케이블 재접합, 메모리 보드 교체 필요 (외부 전자 서비스)',
  ...
  // SAR System failed repair attempt
  {
    ...
    repairDescription: '온도 제어 시스템 수리 시도 (제조사 인증 기술자)',
    repairResult: 'failed',
