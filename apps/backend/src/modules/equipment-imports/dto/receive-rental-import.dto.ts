...
export const receiveRentalImportSchema = z
  .object({
...
export type ReceiveRentalImportInput = z.infer<typeof receiveRentalImportSchema>;
export const ReceiveRentalImportValidationPipe = new ZodValidationPipe(receiveRentalImportSchema);

export class ReceiveRentalImportDto {
  @ApiProperty({
