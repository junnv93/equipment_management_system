...
export const createMockDocumentService = (): Record<string, jest.Mock> => ({
  ...
  findBySoftwareValidationId: jest.fn().mockResolvedValue([]),
  findByIntermediateInspectionId: jest.fn().mockResolvedValue([]),
  findBySelfInspectionId: jest.fn().mockResolvedValue([]),
