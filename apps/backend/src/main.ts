...
async function bootstrap(): Promise<void> {
  ...
  // - 중복 제거: class-validator와 Zod 중복 검증 제거
  //
  // 참고:
  ...
  //
  // ⚠️ 마이그레이션 상태:
  // - Equipment, Rentals, Checkouts 모듈: Zod 기반 검증 완료 ✅
  // - Reservations 모듈: Rentals 모듈로 통합 완료 (제거됨)
  // - Users, Auth, Calibration 등: 아직 class-validator 사용 중 (Zod로 마이그레이션 필요)
  //
