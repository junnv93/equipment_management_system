...
CREATE TYPE "public"."equipment_status" AS ENUM('available', 'checked_out', 'calibration_scheduled', 'calibration_overdue', 'non_conforming', 'spare', 'retired', 'pending_disposal', 'disposed', 'temporary', 'inactive');--> statement-breakpoint
...
CREATE INDEX "self_inspection_items_inspection_id_idx" ON "self_inspection_items" USING btree ("inspection_id");--> statement-breakpoint
...
CREATE INDEX "equipment_deputy_manager_id_idx" ON "equipment" USING btree ("deputy_manager_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "form_templates_current_idx" ON "form_templates" USING btree ("form_name") WHERE "form_templates"."is_current" = true;--> statement-breakpoint
CREATE UNIQUE INDEX "form_templates_form_number_unique" ON "form_templates" USING btree ("form_number");--> statement-breakpoint
