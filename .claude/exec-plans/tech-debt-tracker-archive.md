...
| 파일 | 도메인 | 주요 내용 |
|------|--------|-----------|
| [archive-inspection.md](./archive-inspection.md) | 자체점검 / 중간점검 | inspection-pr2-pr3-closure 후속: rowBaseDecoration 토큰 + ToggleGroup dark mode |
| [archive-errors-ssot.md](./archive-errors-ssot.md) | ErrorCode SSOT & Defense-in-Depth | tier-2-rejectmodal SSOT + disposal/calibration fail-close + equipment reject hardening + FSM inline→ErrorCode |
| [archive-checkouts.md](./archive-checkouts.md) | 체크아웃 & 승인 도메인 | Sprint 4.5, approvals-ui-r2, FSM, BFF, tech-debt-0427-open, design-token SSOT, checkout-subtab-ia/lender-guard/fsm |

이 파일에는 **2026-04-28 이후 비-체크아웃 도메인** 완료 항목이 기록됩니다 (dashboard, i18n, supply-chain, SW검증, NC, calibration, 인프라 등).
