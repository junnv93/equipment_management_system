...
- [ ] **[2026-04-16 e2e-infra-redesign] S2 — data-migration.service.spec.ts lint 에러** — 미사용 변수 4개 (`MOCK_USER_ID`, `MOCK_SESSION_ID`, `MOCK_VALID_ROW`, `makeMockFile`). E2E 재설계 범위 외 파일.
- [ ] **[2026-04-16 e2e-infra-redesign] S3 — beforeAll 축소** — `equipment-approval.e2e-spec.ts` (25줄), `calibration-plans.e2e-spec.ts` (27줄). 목표 15줄 이하.
- [ ] **[2026-04-16 e2e-infra-redesign] S4 — afterAll 축소** — `equipment-history.e2e-spec.ts` (26줄). 목표 10줄 이하. 이력 삭제 로직을 ResourceTracker 확장으로 해결 가능.
