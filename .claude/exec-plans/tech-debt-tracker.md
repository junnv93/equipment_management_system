...
- [ ] **[2026-04-29 checkout-url-first-state] 🟢 LOW S6 parseCheckoutCreateParams-unit-test** — `apps/frontend/lib/utils/__tests__/checkout-create-params.test.ts` 단위 테스트 미작성. 7 케이스: 빈 입력 / equipmentId only / purpose only / 둘 다 / 잘못된 purpose / encoded ID / undefined purpose. Evaluator SHOULD S6 실패.
