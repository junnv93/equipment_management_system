...
- [x] **[2026-05-09 phase-c-r2 후속] 🟢 LOW use-equipment-calibrations-hook-spec** — `terror-s1-hook-spec` 2026-05-09 closure. 7 tests PASS (export 시그니처 × 2 + useEquipmentCalibrations 3 + useEquipmentCalibrationHistory 4 — pageSize 분기 포함).
...
- [x] **[2026-05-09 tErrors S-1] 🟡 MED errors.genericError baseline key 추가** — `terror-s1-hook-spec` 2026-05-09 closure. 8파일 genericError 추가 + verify-i18n Step 20 16검증 PASS.
