...
- [ ] **[2026-04-22 subtab-ia-followup] 🟢 LOW handleSubTabChange URL 직접 조작** — `OutboundCheckoutsTab.tsx:handleSubTabChange`: `new URLSearchParams(searchParams.toString())` 직접 조작 잔존 (subTab delete 로직으로 인해 filtersToSearchParams 적용 난이도 있음). 트리거: filtersToSearchParams에 subTab 기본값 처리 로직 추가 시.
