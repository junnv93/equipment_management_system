...
- [ ] **[2026-04-20 review-architecture] FE: ValidationDetailContent `useCasGuardedMutation` 교체** — `ValidationDetailContent.tsx:123`. `useMutation` 직접 + `isConflictError` 수동 처리. `useCasGuardedMutation`으로 교체 시 VERSION_CONFLICT 에러 표준화.
