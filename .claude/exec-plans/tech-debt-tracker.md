...
- [x] **[2026-04-18 arch-rev2] 🟡 MEDIUM exportSoftwareValidation resolveUser N+1** — ✅ 완료 2026-04-19 (api-ssot-e2e-serial-export-batch). `submittedBy` → `userIdSet` 배치 추가. `inArray()` 단일 배치 조회 + Map 분배 패턴 이미 적용된 상태, 누락 필드 추가로 완결.
