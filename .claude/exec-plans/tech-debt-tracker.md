...
- [x] MC.4: Phase 5a/5b/5c가 1개 커밋으로 병합됨 (계약은 독립 커밋 요구). 코드는 정상, 커밋 분리는 불필요 — ✅ 확인 종결 2026-04-21
...
- [ ] ValidationDocumentsSection.tsx: 243줄 (≤150줄 SHOULD 권고 초과) — _components/ValidationDocumentsSection.tsx — 2026-04-21
- [ ] ValidationEditDialog.tsx: 183줄 (≤150줄 SHOULD 권고 초과) — _components/ValidationEditDialog.tsx — 2026-04-21
