...
- [ ] **[2026-04-24 pr4-7] 🟢 LOW en/checkouts.json 3개 키 누락** — `actions.cancelCheckout`, `dialogs.cancelTitle`, `dialogs.cancelDescription` en/checkouts.json에 없음. `CheckoutDetailClient.tsx`에서 실사용 중 — 영어 로케일에서 raw 키 노출. 트리거: i18n 정리 작업 시.
