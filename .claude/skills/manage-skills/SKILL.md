...
| `verify-frontend-state` | 프론트엔드 상태 관리 패턴 검증 (Step 21: runtime feature flag로 union 타입 내로잉 금지, Step 22: bulk 뮤테이션 `Promise.allSettled` 병렬 — `for...of` 순차 금지) | `apps/frontend/components/**`, `apps/frontend/hooks/**`, `apps/frontend/lib/checkouts/**`  |
