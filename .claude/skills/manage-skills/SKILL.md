...
| `verify-design-tokens`  | Design Token 3-Layer 아키텍처 검증 (Step 33: DASHBOARD_ENTRANCE/DASHBOARD_MOTION 인라인 딜레이 금지, Step 34: WAI-ARIA grid 3단계 패턴, Step 35: CHECKOUT_ITEM_ROW_TOKENS zone key satisfies, Step 36: WORKFLOW_PANEL_TOKENS.actor satisfies + WorkflowPanelActorVariant, Step 37: Layer 3 토큰 파일 내 ANIMATION_PRESETS 인라인 우회 금지, Step 38: AlertBanner severity → ARIA role 분기) | `lib/design-tokens/**`, `apps/frontend/components/**`, `styles/globals.css`                 |
