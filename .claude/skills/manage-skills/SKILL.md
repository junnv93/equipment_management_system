...
| `verify-checkout-fsm`   | Checkout FSM SSOT 아키텍처 검증 — Dependency Inversion(UserRole import 금지), assertFsmInvariants 호출, CheckoutPermissionKey 동기화 | `packages/schemas/src/fsm/checkout-fsm.ts`, `packages/schemas/src/checkout.ts` |
