...
| `verify-i18n`           | i18n 번역 + routeMap↔navigation.json + audit SSOT enum 동기화 검증 (Step 15: commentRequired=true ↔ commentDialogTitleKey/commentPlaceholderKey i18n 존재 검증) | `apps/frontend/messages/{en,ko}/*.json`, `lib/navigation/route-metadata.ts`, `packages/schemas/src/enums/audit.ts` |
