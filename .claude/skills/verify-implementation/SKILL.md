...
| 6  | `verify-nextjs`         | frontend | Next.js 16 패턴 — await params, useActionState, PPR-compatible layout(sync outer+Suspense, Step 9), session.user.role typeof guard(Step 10, 2026-05-13) |
