...
| 8  | `verify-design-tokens`  | frontend | Design Token 3-Layer, Dialog ARIA 입력 검증 패턴(Step 49), 내비게이션 list 시맨틱 `<ul role="list">` + `<li>`(Step 50), mono 헬퍼 `.text-mono`/`.text-mono-base` utility 경유(Step 54, 2026-05-13), brand-color-* oklch SSOT — hsl wrapper 0 + color-mix(in oklch) alpha 합성(Step 55, 2026-05-13 g4-g12-round3) |
