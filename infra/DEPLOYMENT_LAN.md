...
> Deprecated: 이 문서는 과거 “회사 데스크탑을 운영 서버로 사용”하는 LAN 배포 기준입니다.
> 신규 운영 배포는 회사 보안정책에 따라 관리되는 온프레미스 서버 또는 클라우드 서버를 사용해야 합니다.
> 온프레미스 서버 배포 절차는 [ONPREM_DEPLOYMENT.md](./ONPREM_DEPLOYMENT.md)를 기준으로 합니다.
