...
const REQUIRED_PATHS = [
  ...
  // completed/return_rejected은 비-enum UI 전용 → help.statusUi 네임스페이스
  'help.statusUi.completed.title',
  'help.statusUi.completed.description',
  'help.statusUi.return_rejected.title',
  'help.statusUi.return_rejected.description',
