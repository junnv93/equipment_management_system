...
| --------------- | ----------------------------- | :--: | :--: | --------------- | -------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| **UL-QP-18-01** | 시험설비 관리대장             |  ✅  | XLSX | 통합            | [양식](../procedure/양식/QP-18-01_시험설비관리대장.md)         | [§3.1](./report-export-mapping.md#31-ul-qp-18-01-시험설비-관리대장-xlsx)                    | `modules/reports/{layouts,services}/equipment-registry.*.ts` + `xlsx-helper.ts` (3-way 분리, 2026-04-17 교체)      |
...
| **UL-QP-18-03** | 중간 점검표                   |  ✅  | DOCX | 통합            | [양식](../procedure/양식/QP-18-03_중간점검표.md)               | [§3.3](./report-export-mapping.md#33-ul-qp-18-03-중간점검표-docx)                           | `modules/intermediate-inspections/services/intermediate-inspection.*.ts` (3-way 분리, 2026-04-17 교체)             |
| **UL-QP-18-05** | 자체 점검표                   |  ✅  | DOCX | 통합            | [양식](../procedure/양식/QP-18-05_자체점검표.md)               | [§3.4](./report-export-mapping.md#34-ul-qp-18-05-자체점검표-docx)                           | `modules/self-inspections/services/self-inspection.*.ts` (3-way 분리, 2026-04-17 교체, classification snapshot)    |
...
| **UL-QP-18-11** | 보정인자 및 파라미터 관리대장 |  ✅  | DOCX | 통합            | [양식](../procedure/양식/QP-18-11_보정인자파라미터관리대장.md) | [§3.10](./report-export-mapping.md#310-ul-qp-18-11-보정인자-및-파라미터-관리대장-docx)      | `modules/reports/services/calibration-factor-register-*.ts`                                                        |
