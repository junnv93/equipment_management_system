(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (__turbopack_context__, module, exports) => {
    ...
    async function fetchServerResponse(url, options) {
      ...
      try {
        ...
        const isLegacyPPR =
          ('TURBOPACK compile-time value', true) && !('TURBOPACK compile-time value', true);
  ...
  (__turbopack_context__, module, exports) => {
    ...
    function updateCacheNodeOnNavigation(
      ...
      const refreshUrl =
        typeof href === 'string' && newRouterState[3] === 'refresh' ? href : parentRefreshUrl;
      ...
      switch (freshness) {
        case 0:
          ...
          shouldRefreshDynamicData =
            oldCacheNode === undefined ||
            navigatedAt - oldCacheNode.navigatedAt >= _navigatereducer.DYNAMIC_STALETIME_MS;
          ...
          case _cache.EntryStatus.Empty: {
            if (background(task)) {
              ...
              spawnPrefetchSubtask(
                (0, _cache.fetchRouteOnCacheMiss)(routeWithoutSearch, task, keyWithoutSearch)
              );
            }
            break;
          }
