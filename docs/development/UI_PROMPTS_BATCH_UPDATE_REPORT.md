...
**백업 파일 위치**:
```
/home/kmjkd/equipment_management_system-1/docs/development/FRONTEND_UI_PROMPTS_backup_*.tar.gz
```

필요 시 롤백 가능:
```bash
cd /home/kmjkd/equipment_management_system-1/docs/development
