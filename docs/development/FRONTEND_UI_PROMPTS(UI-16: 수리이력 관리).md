...
파일:
- apps/frontend/app/equipment/[id]/repair-history/page.tsx
- apps/frontend/app/maintenance/page.tsx (수리 목록)
- apps/frontend/app/maintenance/create/page.tsx (수리 등록)
- apps/frontend/components/repair/RepairHistoryTimeline.tsx
- apps/frontend/components/repair/RepairForm.tsx
- apps/frontend/lib/api/repair-api.ts
...
- [ ] equipment/[id]/repair-history/page.tsx 구현됨
- [ ] maintenance/page.tsx 구현됨
- [ ] maintenance/create/page.tsx 구현됨
- [ ] RepairHistoryTimeline.tsx 컴포넌트 개선됨
- [ ] RepairForm.tsx 컴포넌트 생성됨
- [ ] repair-api.ts API 함수 생성됨
- [ ] 타임라인 UI 구현됨
- [ ] 장비 상태 변경 연동됨
