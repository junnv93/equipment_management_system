...
파일:
- apps/frontend/app/checkouts/page.tsx (내 반출 목록)
- apps/frontend/app/checkouts/create/page.tsx (반출 신청)
- apps/frontend/app/checkouts/manage/page.tsx (반출 관리)
- apps/frontend/app/admin/return-approvals/page.tsx (반입 승인)
- apps/frontend/components/checkouts/CheckoutForm.tsx
- apps/frontend/components/checkouts/CheckoutList.tsx
- apps/frontend/components/checkouts/ReturnInspectionForm.tsx
- apps/frontend/components/checkouts/CheckoutTypeSelector.tsx
...
- [ ] checkouts/page.tsx 구현됨
- [ ] checkouts/create/page.tsx 구현됨
- [ ] checkouts/manage/page.tsx 구현됨
- [ ] admin/return-approvals/page.tsx 구현됨
- [ ] CheckoutForm.tsx 컴포넌트 생성됨
- [ ] CheckoutList.tsx 컴포넌트 생성됨
- [ ] ReturnInspectionForm.tsx 컴포넌트 개선됨
- [ ] CheckoutTypeSelector.tsx 컴포넌트 생성됨
- [ ] checkout-api.ts API 함수 생성됨
- [ ] 유형별 검사 항목 구현됨
- [ ] 시험소간 대여 양측 확인 구현됨
