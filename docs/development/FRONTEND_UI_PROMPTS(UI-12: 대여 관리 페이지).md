...
파일:
- apps/frontend/app/rentals/page.tsx (내 대여 목록)
- apps/frontend/app/rentals/create/page.tsx (대여 신청)
- apps/frontend/app/rentals/manage/page.tsx (대여 관리)
- apps/frontend/components/rentals/RentalForm.tsx
- apps/frontend/components/rentals/RentalList.tsx
- apps/frontend/components/rentals/RentalApprovalList.tsx
- apps/frontend/components/rentals/ReturnForm.tsx
...
- [ ] rentals/page.tsx 구현됨
- [ ] rentals/create/page.tsx 구현됨
- [ ] rentals/manage/page.tsx 구현됨
- [ ] RentalForm.tsx 컴포넌트 생성됨
- [ ] RentalList.tsx 컴포넌트 생성됨
- [ ] RentalApprovalList.tsx 컴포넌트 생성됨
- [ ] ReturnForm.tsx 컴포넌트 생성됨
- [ ] rental-api.ts API 함수 생성됨
- [ ] 자동 승인 로직 구현됨
- [ ] 연체 표시 구현됨
